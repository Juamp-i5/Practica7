package mx.edu.itson.practica7
...
import mx.edu.itson.practica7.domain.Pokemon
import mx.edu.itson.practica7.ui.theme.Practica7Theme
...
class MainActivity : ComponentActivity() {
    val pokemon = Pokemon(
        ...
        number = 25,
        type = "Electrico",
        description = "Pikachu almacena electricidad en sus mejillas. Cuando libera toda esa energía, puede generar potentes descargas eléctricas.",
        height = 0.4f,
        weight = 6f,
        fav = true,
        ability = "Estática",
